export declare type Arguments = yargsParser.Arguments;

export declare type Configuration = yargsParser.Configuration;

export declare type DetailedArguments = yargsParser.DetailedArguments;

export declare type Options = yargsParser.Options;

export declare type Parser = yargsParser.Parser;
