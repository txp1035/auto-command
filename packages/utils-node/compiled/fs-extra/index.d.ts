...
export declare function access(path: PathLike, callback: (err: NodeJS.ErrnoException) => void): void;

export declare function access(path: PathLike, mode: number, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function appendFile(file: PathLike | number, data: any, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function chmod(path: PathLike, mode: Mode, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function chown(path: PathLike, uid: number, gid: number, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function copyFile(src: string, dest: string, flags: number, callback: (err: Error) => void): void;
...
export declare function createSymlink(src: string, dest: string, type: SymlinkType, callback?: (err: Error) => void): void;
...
export declare function ensureDir(path: string, options?: EnsureOptions | number, callback?: (err: Error) => void): void;
...
export declare function ensureSymlink(src: string, dest: string, type: SymlinkType, callback: (err: Error) => void): void;

export declare function ensureSymlink(src: string, dest: string, callback: (err: Error) => void): void;

export declare function ensureSymlinkSync(src: string, dest: string, type?: SymlinkType): void;

export declare function fchmod(fd: number, mode: Mode, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function lchown(path: PathLike, uid: number, gid: number, callback: (err: NodeJS.ErrnoException) => void): void;

export declare function lchown(path: PathLike, uid: number, gid: number): Promise<void>;

export declare function link(existingPath: PathLike, newPath: PathLike, callback: (err: NodeJS.ErrnoException) => void): void;

export declare function link(existingPath: PathLike, newPath: PathLike): Promise<void>;

export declare function lstat(path: PathLike, callback: (err: NodeJS.ErrnoException, stats: Stats) => any): void;
...
export declare function mkdir(path: PathLike, options?: Mode | fs.MakeDirectoryOptions | null): Promise<void>;
...
export declare function mkdirSync(path: PathLike, options?: Mode | fs.MakeDirectoryOptions | null): void;
...
export declare function mkdtemp(prefix: string, callback: (err: NodeJS.ErrnoException, folder: string) => void): void;
...
declare function open_2(path: PathLike, flags: string | number, mode?: Mode | null): Promise<number>;
export { open_2 as open }

export declare function opendir(path: string, cb: (err: NodeJS.ErrnoException | null, dir: fs.Dir) => void): void;
...
export declare function outputFileSync(file: string, data: any, options?: WriteFileOptions | BufferEncoding | string): void;

export declare function outputJSON(file: string, data: any, options?: WriteOptions | BufferEncoding | string): Promise<void>;
...
export declare function outputJSONSync(file: string, data: any, options?: WriteOptions | BufferEncoding | string): void;
...
export declare function readdir(path: PathLike, callback: (err: NodeJS.ErrnoException, files: string[]) => void): void;
...
export declare function readFile(file: PathLike | number, callback: (err: NodeJS.ErrnoException, data: Buffer) => void): void;
...
export declare function readFile(file: PathLike | number, encoding: BufferEncoding | string): Promise<string>;

export declare function readFile(file: PathLike | number): Promise<Buffer>;

export declare function readJSON(file: string, options?: ReadOptions | BufferEncoding | string): Promise<any>;
...
export declare function readJSONSync(file: string, options?: ReadOptions | BufferEncoding | string): any;

export declare function readJsonSync(file: string, options?: ReadOptions | BufferEncoding | string): any;

export declare function readlink(path: PathLike, callback: (err: NodeJS.ErrnoException, linkString: string) => any): void;
...
export declare function realpath(path: PathLike, callback: (err: NodeJS.ErrnoException, resolvedPath: string) => any): void;
...
export declare function realpath(path: PathLike, cache?: { [path: string]: string }): Promise<string>;
...
export declare function rename(oldPath: PathLike, newPath: PathLike, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function stat(path: PathLike, callback: (err: NodeJS.ErrnoException, stats: Stats) => any): void;
...
export declare function symlink(target: PathLike, path: PathLike, callback: (err: NodeJS.ErrnoException) => void): void;

export declare function symlink(target: PathLike, path: PathLike, type?: SymlinkType): Promise<void>;

export declare type SymlinkType = 'dir' | 'file' | 'junction';

export declare function truncate(path: PathLike, callback: (err: NodeJS.ErrnoException) => void): void;

export declare function truncate(path: PathLike, len: number, callback: (err: NodeJS.ErrnoException) => void): void;
 ...
 * @param callback No arguments other than a possible exception are given to the completion callback.
 */
export declare function unlink(path: PathLike, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function utimes(path: PathLike, atime: Date, mtime: Date, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function writeFile(file: PathLike | number, data: any, callback: (err: NodeJS.ErrnoException) => void): void;
...
export declare function writeJSON(file: string, object: any, options?: WriteOptions | BufferEncoding | string): Promise<void>;
...
export declare function writeJSONSync(file: string, object: any, options?: WriteOptions | BufferEncoding | string): void;
...
export declare function writev(fd: number, buffers: NodeJS.ArrayBufferView[], position?: number): Promise<WritevResult>;
